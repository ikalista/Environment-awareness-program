...
public class WeatherAlarm
{
    ...
    {
		weather_array = new String[11];
		filename = "D:\\Program Files\\Eclipse\\eclipse-workspace\\NewProject\\weather_alarm.txt";
		try {
			File weather_file = new File(filename);
			
			Scanner myReader1 = new Scanner(weather_file);
			
			int count = 0;
			while (myReader1.hasNextLine()) {
				weather_array[count] = myReader1.nextLine();
				count ++;
			}
			myReader1.close();	
